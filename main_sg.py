...
from load_data import generate_stellar_graph
...
######## Specify the minibatch size (# user-movie links per minibatch)
######## and the number of epochs for training the ML model
batch_size = 200
epochs = 20
train_size = 0.7
test_size = 0.3
...
######## Load the dataset
G, edges_with_ratings = generate_stellar_graph()
print(G.info())
...
######## num_samples defines the number of layers/iterations in the hinSAGE model
num_samples = [8, 4]

######## Create generators to feed data from graph to Keras model
